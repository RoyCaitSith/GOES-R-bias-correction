...
pdfname = dir_main + '/Figures/hwll.pdf'
...
with PdfPages(pdfname) as pdf:
    ...
    for idv, var in enumerate(variables.keys()):
        ...
        temp    = np.loadtxt(dir_main + '/Results/hwll_' + var + '.txt').reshape(nsig, mlat+2)
        temp_1d = temp[:,1:mlat+1].ravel()
        temp_2d = griddata((lat_1d, sig_1d), temp_1d/1000.0, (lat_2d, sig_2d), method='linear')
        ...
        clb.set_label('km', fontsize=7.5, labelpad=4.0)
