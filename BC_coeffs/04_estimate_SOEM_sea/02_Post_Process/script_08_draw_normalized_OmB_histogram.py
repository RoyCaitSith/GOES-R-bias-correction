...
maintitle        = ['Before bias correction']
channel          = 8
schemes          = {'All Sky':    [('normalized OmB', 0, 0.5, '#000000'), ('all-sky scaled OmB',  3, 1.0, '#d62728')],
                    'Clear Sky':  [('normalized OmB', 1, 0.5, '#000000'), ('all-sky scaled OmB',  4, 1.0, '#d62728')],
                    'Cloudy Sky': [('normalized OmB', 2, 0.5, '#000000'), ('all-sky scaled OmB',  5, 1.0, '#d62728')]}
