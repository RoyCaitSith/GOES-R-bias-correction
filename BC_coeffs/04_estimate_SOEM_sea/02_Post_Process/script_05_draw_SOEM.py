...
#dir_SOEM = dir_main + '/02_Post_Process/2020082200_06h'
...
for datathinning in thingrid:
    for dom in domains:
        for fhours in forecast_hours:
            ...
            #pdfname  = dir_save + '/' + anl_start_time_str + '_' + anl_end_time_str + '_' + datathinning + '_' + \
                       #dom + '_' + str(fhours).zfill(2) + 'h_channel_' + str(channel).zfill(2) + '_SOEM_water.pdf'
            #filesave = dir_SOEM + '/' + anl_start_time_str + '_' + anl_end_time_str + '_' + datathinning + '_' + \
                       #dom + '_' + str(fhours).zfill(2) + 'h_channel_' + str(channel).zfill(2) + '_SOEM_parameters_water.txt'
            #pdfname  = dir_save + '/' + anl_start_time_str + '_' + anl_end_time_str + '_' + datathinning + '_' + \
                       #dom + '_' + str(fhours).zfill(2) + 'h_channel_' + str(channel).zfill(2) + '_SOEM_land.pdf'
            #filesave = dir_SOEM + '/' + anl_start_time_str + '_' + anl_end_time_str + '_' + datathinning + '_' + \
                       #dom + '_' + str(fhours).zfill(2) + 'h_channel_' + str(channel).zfill(2) + '_SOEM_parameters_land.txt'
            ...
            with PdfPages(pdfname) as pdf:
                ...
                (var, range_min, range_max, range_interval, var_color, lb) = ('OmB_before_BC', -74.75, 150.25, 0.5, '#1f77b4', 'before BC')
                ...
                #filename = dir_SOEM + '/' + anl_start_time_str + '_' + anl_end_time_str + '_' + datathinning + '_' + dom + '_' + \
                           #str(fhours).zfill(2) + 'h_channel_' + str(channel).zfill(2) + '_' + var + '_SOEM_water.txt'
                #filename = dir_SOEM + '/' + anl_start_time_str + '_' + anl_end_time_str + '_' + datathinning + '_' + dom + '_' + \
                           #str(fhours).zfill(2) + 'h_channel_' + str(channel).zfill(2) + '_' + var + '_SOEM_land.txt'
                print(filename)
