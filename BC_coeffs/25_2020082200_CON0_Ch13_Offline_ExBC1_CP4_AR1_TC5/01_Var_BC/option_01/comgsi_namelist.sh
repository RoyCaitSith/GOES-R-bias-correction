...
cat <<EOF > gsiparm.anl
 ...
 &SETUP
   ...
   gencode=78,qoption=2,cwoption=3,
 ...
 /
 &OBS_INPUT
   dmesh(1)=120.0,dmesh(2)=60.0,dmesh(3)=30,dmesh(4)=30,time_window_max=1.5,ext_sonde=.true.,
 /
OBS_INPUT::
!  dfile          dtype       dplat     dsis                 dval    dthin dsfcalc
   ...
   gmibufr        gmi         gpm       gmi_gpm             10.0     3     0
   abibufr        abi         g16       abi_g16              1.5     4     0
::
 &SUPEROB_RADAR
 ...
 &HYBRID_ENSEMBLE
   ...
   n_ens=${nummem},
   beta_s0=0.2,s_ens_h=110,s_ens_v=3,
