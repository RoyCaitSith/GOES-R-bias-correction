...
DATA_DIR=/uufs/chpc.utah.edu/common/home/zpu-group16/cfeng/02_GOES_Bias_Correction/24_Revision/cycling_da/Laura_ASRBC1CLDC12
...
PREPBUFR=${OBS_ROOT}/gdas.t${HH}z.prepbufr
BK_ROOT=${DATA_DIR}/${ANAL_TIME}/bkg
BK_FILE=${BK_ROOT}/wrfout_${DOMAIN_NAME}_${YY}-${MM}-${DD}_${HH}:00:00
WRFINPUT_ROOT=${DATA_DIR}/${ANAL_TIME}/wrfinput
#ENS_ROOT is not required if not running hybrid EnVAR 
ENS_ROOT=${DATA_DIR}/${ANAL_TIME}/gfsens
OPTION_ROOT=/uufs/chpc.utah.edu/common/home/zpu-group16/cfeng/02_GOES_Bias_Correction/24_Revision/cycling_da/Data/Laura/ASRBC1CLDC12/option

GSI_ROOT=/uufs/chpc.utah.edu/common/home/zpu-group16/cfeng/comGSIv3.7_EnKFv1.3
#assume you have a copy of gsi.x here
GSI_EXE=${OPTION_ROOT}/gsi.x  
FIX_ROOT=${GSI_ROOT}/fix
CRTM_ROOT=${FIX_ROOT}/CRTM_v2.3.0
USH_ROOT=${GSI_ROOT}/ush
GSI_NAMELIST=${OPTION_ROOT}/comgsi_namelist.sh

JOB_DIR=${DATA_DIR}/${ANAL_TIME}
RUN_NAME=case_${DOMAIN_NAME}
...
if_nemsio=Yes    # Yes, or, No -- case sensitive !
...
RUN_COMMAND="mpirun -genv OMP_NUM_THREADS=1 -np ${GSIPROC} "
fi ;;
...
# ln -s ${OBS_ROOT}/gfs.t${HH}z.sptrmm.tm00.bufr_d tmirrbufr
# Link to the radiance data
srcobsfile[1]=${OBS_ROOT}/gdas.t${HH}z.satwnd.tm00.bufr_d
gsiobsfile[1]=satwnd
srcobsfile[2]=${OBS_ROOT}/gdas.t${HH}z.1bamua.tm00.bufr_d
gsiobsfile[2]=amsuabufr
srcobsfile[3]=${OBS_ROOT}/gdas.t${HH}z.1bhrs4.tm00.bufr_d
gsiobsfile[3]=hirs4bufr
srcobsfile[4]=${OBS_ROOT}/gdas.t${HH}z.1bmhs.tm00.bufr_d
gsiobsfile[4]=mhsbufr
srcobsfile[5]=${OBS_ROOT}/gdas.t${HH}z.1bamub.tm00.bufr_d
gsiobsfile[5]=amsubbufr
srcobsfile[6]=${OBS_ROOT}/gdas.t${HH}z.ssmisu.tm00.bufr_d
gsiobsfile[6]=ssmirrbufr
srcobsfile[7]=${OBS_ROOT}/gdas.t${HH}z.airsev.tm00.bufr_d
gsiobsfile[7]=airsbufr
srcobsfile[8]=${OBS_ROOT}/gdas.t${HH}z.sevcsr.tm00.bufr_d
gsiobsfile[8]=seviribufr
srcobsfile[9]=${OBS_ROOT}/gdas.t${HH}z.iasidb.tm00.bufr_d
gsiobsfile[9]=iasibufr
srcobsfile[10]=${OBS_ROOT}/gdas.t${HH}z.gpsro.tm00.bufr_d
gsiobsfile[10]=gpsrobufr
srcobsfile[11]=${OBS_ROOT}/gdas.t${HH}z.amsr2.tm00.bufr_d
gsiobsfile[11]=amsrebufr
srcobsfile[12]=${OBS_ROOT}/gdas.t${HH}z.atms.tm00.bufr_d
gsiobsfile[12]=atmsbufr
srcobsfile[13]=${OBS_ROOT}/gdas.t${HH}z.geoimr.tm00.bufr_d
gsiobsfile[13]=gimgrbufr
srcobsfile[14]=${OBS_ROOT}/gdas.t${HH}z.gome.tm00.bufr_d
gsiobsfile[14]=gomebufr
srcobsfile[15]=${OBS_ROOT}/gdas.t${HH}z.omi.tm00.bufr_d
gsiobsfile[15]=omibufr
srcobsfile[16]=${OBS_ROOT}/gdas.t${HH}z.osbuv8.tm00.bufr_d
gsiobsfile[16]=sbuvbufr
srcobsfile[17]=${OBS_ROOT}/gdas.t${HH}z.eshrs3.tm00.bufr_d
gsiobsfile[17]=hirs3bufrears
srcobsfile[18]=${OBS_ROOT}/gdas.t${HH}z.esamua.tm00.bufr_d
gsiobsfile[18]=amsuabufrears
srcobsfile[19]=${OBS_ROOT}/gdas.t${HH}z.esmhs.tm00.bufr_d
...
srcobsfile[22]=${OBS_ROOT}/gdas.t${HH}z.glm.tm00.bufr_d
gsiobsfile[22]=glmbufr
srcobsfile[23]=${OBS_ROOT}/gdas.t${HH}z.gmi.tm00.bufr_d
gsiobsfile[23]=gmibufr
srcobsfile[24]=${OBS_ROOT}/gdas.t${HH}z.goesrabi.tm00.bufr_d
gsiobsfile[24]=abibufr
ii=1
while [[ $ii -le 24 ]]; do
...
if [ ${bk_core} = ARW ] ; then
ANAVINFO=${OPTION_ROOT}/anavinfo_arw_netcdf_glbe
fi
...
SATINFO=${OPTION_ROOT}/global_satinfo.txt
CONVINFO=${FIX_ROOT}/global_convinfo.txt
OZINFO=${FIX_ROOT}/global_ozinfo.txt
PCPINFO=${FIX_ROOT}/global_pcpinfo.txt
LIGHTINFO=${FIX_ROOT}/global_lightinfo.txt
CLOUDYINFO=${OPTION_ROOT}/cloudy_radiance_info.txt
...
cp ${OPTION_ROOT}/comgsi_satbias_in ./satbias_in
cp ${OPTION_ROOT}/comgsi_satbias_pc_in ./satbias_pc
